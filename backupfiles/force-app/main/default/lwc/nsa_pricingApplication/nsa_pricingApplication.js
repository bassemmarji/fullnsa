...
import checkEmployerGroup from "@salesforce/apex/NSA_EOBEntryFormController.checkEmployerGroup";
//import getProviderByNPI from "@salesforce/apex/NSA_EOBEntryFormController.getProviderByNPI";
import createJiraTicket from "@salesforce/apex/NSA_EOBEntryFormController.createJiraTicket";
import hasOutOfNetwork from "@salesforce/apex/NSA_EOBEntryFormController.hasOutOfNetwork";
import handleSQLError from "@salesforce/apex/NSA_EOBEntryFormController.handleSQLError";
import getNetworksDetails from "@salesforce/apex/NSA_EOBEntryFormController.getNetworksDetails";
import getTPAAcro from "@salesforce/apex/NSA_EOBEntryFormController.getTPAAcro";
import insertSL from "@salesforce/apex/NSA_EOBEntryFormController.serviceLineInsert";
import serviceLineInsertPodPlan from "@salesforce/apex/NSA_EOBEntryFormController.serviceLineInsertPodPlan";
import getPatientInfo from "@salesforce/apex/NSA_EOBEntryFormController.getPatientInformation";
import getPatient from "@salesforce/apex/NSA_EOBEntryFormController.getPatient";
import getHPIList from "@salesforce/apex/NSA_EOBEntryFormController.getHPIList";
import getHPCList from "@salesforce/apex/NSA_EOBEntryFormController.getHPCList";
import checkExistingNPI from "@salesforce/apex/NSA_EOBEntryFormController.checkExistingNPI";
//import getPatientDependents from "@salesforce/apex/NSA_EOBEntryFormController.getPatientDependents";
import triggerCalculation from "@salesforce/apex/NSA_EOBEntryFormController.triggerCalculation";
import getProcedureCodes from "@salesforce/apex/NSA_EOBEntryFormController.getProcedureCodes";
import downloadPDF from '@salesforce/apex/NSA_EOBEntryFormController.getPdfFileAsBase64String';
import serversHeartbeat from "@salesforce/apex/NSA_EOBEntryFormController.serversHeartbeat";
...
export default class Nsa_pricingApplication extends LightningElement {
    @api logoUrl;
    @api fieldSetName;
    ...
    handleEobFormSubmit(event) {
        ...
        if (this.isPodPlan) {
            serviceLineInsertPodPlan({
                ...
                networkNamesDisplay:this.networkNamesDisplay
            }).then((result) => {
...
this.checkQuestionsAsked();
  ...
  /*  handleVFResponse(message) {
    ...
    connectedCallback() {
        console.log('starting application by heartbeats');
        serversHeartbeat()
        .then(data => {
        ...
        getPatientInfo({
            ...
            if (result.Eligibility != null && result.Eligibility.length > 0) {
                if (result.Eligibility.length == 1) {
                    this.fullEligibilityDetails=result.Eligibility[0];
    ...
    getNetworks() {
        ...
        getNetworksDetails({
            ...
            this.networkNamesDisplay = [...this.networkNamesDisplay, this.fullEligibilityDetails.Employer_and_TPA_Plan__r.Pricing_Vendor__r.Name];
            this.networkNames = [...this.networkNames, this.fullEligibilityDetails.Employer_and_TPA_Plan__r.Network_Acronym__c];
            console.log((JSON.stringify(this.networkNamesDisplay)));
            console.log((JSON.stringify(this.networkNames)));
